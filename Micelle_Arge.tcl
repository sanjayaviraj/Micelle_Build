...
puts "Enter number of monomers: "
gets stdin nMol


puts "Enter Spherical radius: "
gets stdin SphericalRadius


#set nMol 50 ; #type number of monomers
#set SphericalRadius 10; #type sphereical radius
